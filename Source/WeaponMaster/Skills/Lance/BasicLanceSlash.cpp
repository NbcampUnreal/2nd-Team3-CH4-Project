...
UBasicLanceSlash::UBasicLanceSlash()
{
}

void UBasicLanceSlash::ExecuteSkill()
{
	Super::ExecuteSkill();
}

int32 UBasicLanceSlash::ProcessTargetActors(const TArray<AActor*>& TargetActors, float Damage)
{
	// 기본 유효성 검사
