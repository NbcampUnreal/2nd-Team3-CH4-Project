...
UIdentityLance::UIdentityLance()
{
}

void UIdentityLance::ExecuteSkill()
{
	Super::ExecuteSkill();
}

int32 UIdentityLance::ProcessTargetActors(const TArray<AActor*>& TargetActors, float Damage)
{
	// 기본 유효성 검사
