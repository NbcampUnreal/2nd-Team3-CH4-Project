...
UCLASS(Abstract)
class GLS_API UGLSWidgetBase : public UUserWidget, public IGLSSaveSystemInterface
{
    GENERATED_BODY()
...
protected:
    ...
    UGLSLogInfoObject* AddFilteredItemToList(TSharedPtr<FGLSLogInfo>& LogDataToAdd, const FContainerFilters& Filters, bool& bAddedToListOut);
