...
UCLASS()
class GLS_API UGLSUtils : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintPure, meta = (DefaultToSelf = "Context"), Category = GLS)
    ...
    UFUNCTION(BlueprintPure, Category = GLS)
    static bool IsLogsEmpty();

    UFUNCTION(BlueprintPure, Category = GLS)
    static const int32 GetLogsNum();

    static const TArray<TSharedPtr<FGLSLogInfo>>& GetLogs();
